...
class P5(Page):
    def is_displayed(self):
        return self.player.ctrl_treat == "control"
    form_model = 'player'
    form_fields = ['algorithm_insights', 'algorithm_insights1', 'algorithm_insights5', 'algorithm_insights6', 'algorithm_insights7', 'algorithm_insights8']
...
class P8(Page):
    def is_displayed(self):
        return self.player.ctrl_treat == "treatment3"
    form_model = 'player'
    form_fields = ['algorithm_insights', 'algorithm_insights4', 'algorithm_insights5', 'algorithm_insights6', 'algorithm_insights7', 'algorithm_insights8']
