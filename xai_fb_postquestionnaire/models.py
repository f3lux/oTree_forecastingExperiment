...
# Adjustment
    ...
    feedback = models.IntegerField(
        label='12. How often did you have a detailed look at the round summary page (when it was available), examining the actual value'
...
# Trust
    ...
    algorithm_insights4_1 = models.IntegerField(
        label='13.2. To which extend did you make use of the table with the bold numbers in order to make your revised '
              'forecast? ',
        choices=[
            [0, 'To a great extent.'],
            [1, 'To a medium extent.'],
            [2, 'To a small extent.'],
            [3, 'To no extent.'],
            [4, 'I did not understand how to read the table.'],
        ],
        widget=widgets.RadioSelect,
    )
    ...
    algorithm_insights8_1 = models.IntegerField(
        label='14.4. To what extent did your level of trust towards the ML algorithm increase/decrease '
              'after you were shown the feedback page?',
        choices=[
            [0, 'Large increase.'],
            [1, 'Slight increase.'],
            [2, 'No change.'],
    ...
    algorithm_insights8_2 = models.StringField(
        label='14.5. Please describe your level of trust towards the algorithm during the different feedback stages:\n'
              ' No direct feedback (fist 10 forecasts) / Direct feedback (next 10 forecasts) / No direct feedback (last'
              ' 10 forecasts).',
        blank=True,
    )

    algorithm_insights8_3 = models.IntegerField(
        label='14.6. Before you got to see the direct feedback, did you try to create a feedback yourself?',
        choices=[
            [0, 'Yes'],
            [1, 'No'],
        ],
